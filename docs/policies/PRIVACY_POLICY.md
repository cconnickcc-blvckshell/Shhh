...
- **Account information:** Phone number (hashed), display name, bio, photos, birthdate, gender, preferences, and verification status.
...
We use cookies and similar technologies on our web properties. See our [Cookie Policy](COOKIE_POLICY.md) for details.
...
To exercise these rights, contact [PRIVACY_EMAIL] or use the in-app settings. We will respond within the timeframes required by applicable law.
...
You may request a copy of the safeguards we use by contacting [PRIVACY_EMAIL].

---

## 11. Children's Privacy

Our Services are not intended for users under 18. We do not knowingly collect data from children. See our [Children's Privacy](CHILDRENS_PRIVACY.md) notice for more information.
...
To exercise these rights, contact [PRIVACY_EMAIL] or use the in-app settings. We will respond within 45 days (with one 45-day extension if needed, with notice). You may designate an authorised agent to submit requests on your behalf; we will verify the agent's authority. If we deny your request, you may appeal by contacting [PRIVACY_EMAIL]; we will inform you of the appeal process and any further options.
...
- **Post:** [COMPANY_ADDRESS] (Attn: Data Protection)

**Accessibility:** If you need this policy in an accessible format, contact [PRIVACY_EMAIL].
