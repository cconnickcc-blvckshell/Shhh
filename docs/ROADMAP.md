...
| Polish (IMPROVEMENTS_LEDGER) | Waves 1–4: activity indicators, deferred profile gates, block/report feedback, privacy cues, analytics events, event reminders, like push. Waves 1–15: accessibility, pass with reason, swipe-to-ignore, micro-copy, unread sync, onboarding Browse first, push throttle, conversion funnel, activity feed, GPS velocity check | See IMPROVEMENTS_LEDGER "What Remains" |
