...
**Live samples:** VU 1 logs first 5 failures per endpoint (10 for create_conversation) as `[FAIL SAMPLE] endpoint status=X (class) body=...`. Check these when create fails to see 403/422/409/etc.
