...
| **429 Too Many Requests** | Global: 500 req/15min default. Set `RATE_LIMIT_MAX_REQUESTS=1000` in Render if needed. Auth: 30 attempts/15min default. Set `AUTH_RATE_LIMIT_MAX=50` if users hit login limits. |
