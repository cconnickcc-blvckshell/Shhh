...
> Last updated: March 2026 (Wave 5: referral flow, post-event invites, venue amplification; Waves 1–4, 9–15, P0)  
...
| GET | `/v1/discover?lat=&lng=&...&inMyGroups=true` | Yes | 0 | Find nearby users. Returns profileVisibilityTier (Wave 2: for privacy cues). Optional inMyGroups; primaryIntent, experienceLevel; discovery_visible_to. Free tier capped at 30; premium or venue/event context uses higher cap. |
...
| Method | Path | Auth | Tier | Description |
|--------|------|------|------|-------------|
| POST | `/v1/analytics/events` | Yes | 0 | Track product event (body: event_type, payload). No PII. Prerequisite for density/trigger metrics. |

### Referrals (Wave 5)
| Method | Path | Auth | Tier | Description |
|--------|------|------|------|-------------|
| GET | `/v1/referrals/me` | Yes | 0 | My referral code and referredCount. Code is 8-char alphanumeric. |
