...
const USERS = [
  { phone: '+15196136330', name: 'Chris Connick', bio: 'Admin account.', gender: 'man', sexuality: 'straight', exp: 'experienced', host: false, kinks: [], tier: 2, role: 'admin', photo: '/photos/stock/portrait_m1.jpg', status: 'id_verified', primaryIntent: 'social' as const, discoveryVisibleTo: 'all' as const },
